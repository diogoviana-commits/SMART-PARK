...
--  Par do db/migration/mysql/V2__indices_de_consulta.sql.
--
--  Nota honesta sobre escala: com as dezenas de linhas que o parque tem hoje, o
--  banco varre a tabela inteira em menos tempo do que levaria para ler um indice.
...
-- aproveita indice comum. Para busca por palavra no meio do texto em escala
-- maior, o caminho no PostgreSQL seria um indice GIN com pg_trgm.
